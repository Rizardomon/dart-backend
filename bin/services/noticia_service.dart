...
class NoticiaService implements GenericService<NoticiaModel> {
  ...
  @override
  Future<bool> delete(int id) async => _noticiaDAO.delete(id);

  @override
  Future<List<NoticiaModel>> findAll() async => _noticiaDAO.findAll();

  @override
  Future<NoticiaModel?> findOne(int id) async => _noticiaDAO.findOne(id);
